...
trait ShutdownAble {
	 ...
	 * The behavior and the conditions that trigger the termination depend on the implementation.
	 * 
	...
	def shutdown(): Unit // TODO rename to "shutdownWhenIdle" and change the implementations that don't do that.
