...
class CooperativeHierarchicalPollingSchedulerDpTest extends DoerProviderTestBase[SchedulingDoerFacade]
	...
	override protected def buildDoerProvider(poolSize: Int): DP = new CooperativeHierarchicalPollingSchedulerDp(applyMemoryFence = false, threadPoolSize = poolSize, threadFactory = new TestThreadFactory) {
