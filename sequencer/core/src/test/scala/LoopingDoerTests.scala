...
/** Trait containing tests for [[Doer]] implementations extended with [[LoopingExtension]].
 */
trait LoopingDoerTests[D <: Doer & LoopingExtension : ClassTag] { self: DoerProviderTestBase[D] =>
