...
/** Trait containing tests for [[Doer]] implementations extended with [[FluxExtension]].
 */
trait FluxDoerTests[D <: Doer & FluxExtension : ClassTag] { self: DoerProviderTestBase[D] =>
