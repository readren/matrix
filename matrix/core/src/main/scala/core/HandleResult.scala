 ...
 * Note that if the [[Behavior.handle]] of the current behavior responds with [[Stop]] to the [[RestartReceived]] signal then the restart is canceled and the [[Reactant]] is stopped instead. 
